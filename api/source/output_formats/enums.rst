...
.. raw:: html
    ...
    MECHANICAL</br>
    <span style="padding: 20px">
    PREMIUM <font color="black">— The <a href="http://docs.cielo24.com/en/latest/output_formats/formats.html#job-info-format-label">Job Info Format</a> returns this value as </font>STANDARD</br>
    <span style="padding: 20px">
    PROFESSIONAL <font color="black">— The <a href="http://docs.cielo24.com/en/latest/output_formats/formats.html#job-info-format-label">Job Info Format</a> returns this value as </font>HIGH</font></br>
    </font>
